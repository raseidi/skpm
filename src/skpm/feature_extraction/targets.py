...
def next_activity(log: LogLike) -> pd.Series:
...
def remaining_time(log: LogLike, time_unit: str = "s") -> pd.Series:
...
def execution_time(log: LogLike, time_unit: str = "s") -> pd.Series:
