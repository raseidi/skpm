...
**SkPM** *(Scikit-learn for Process Mining)* is a library built upon `Scikit-learn <https://scikit-learn.org/stable/>`_ to easily write and train machine learning pipelines tailored for process mining tasks.
